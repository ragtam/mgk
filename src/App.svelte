<script>
	...
	import MyProjectTopLeft from './my-projects/slots/My-Project-Top-Left.svelte';
	import MyProjectBottomLeft from './my-projects/slots/My-Project-Bottom-Left.svelte';
	import MyProjectCard from './my-projects/slots/My-Project-Card.svelte';
	import MyProjectRight from './my-projects/slots/My-Project-Right.svelte';
</script>
...
<style>
	...
	*::after {
	...
	:global([backgroundCssRef='date-faker-background']) {
		background: linear-gradient(180deg, #03ab7a 1%, #4a4a4a 99%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
	}
	...
	:global([backgroundCssRef='indepth-background']) {
		background: linear-gradient(180deg, #a1998c 1%, #4a4a4a 99%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
	}
